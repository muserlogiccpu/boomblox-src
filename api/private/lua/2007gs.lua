...
game:service("Players").PlayerAdded:connect(function(player)	
	...
	local result = game:HttpGet("http://{Url}/Game/Statistics.ashx?TypeID=1&AssociatedUserID=" .. player.userId .. "&serverPort=" .. port .. "&AssociatedPlaceID={PlaceID}&ClientTicket=" .. player.CharacterAppearance .. "&2007=1&t=" .. math.random(1,9999), true)
