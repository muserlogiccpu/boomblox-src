        ...
        if (isset($_POST["__EVENTARGUMENT"]) && isset($_POST["__EVENTTARGET"])) {
            ...
            switch ($_POST["__EVENTTARGET"]) {
                ...
                case 'ctl$cphRoblox$Continue':
                    ...
                    $itemName = str_replace("@", "_", $queuedItem["itemName"]);

                    Discord::sendWebhookMessage("player-post", "New item released! - " . $itemName . " - [bmblox.xyz/Item.aspx?ID=$itemId](https://xoblog.dev/Item.aspx?ID=$itemId)");
