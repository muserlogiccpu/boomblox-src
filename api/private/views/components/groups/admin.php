...
?>
						...
						<div id="MyRobloxContainer">
							...
							<div style="height: 20px; margin-bottom: 3px">
								<h1 style="font-size: 18px; font-weight:bold;" ><?=htmlspecialchars(Helper::debugString($group->name()))?></h1>
							</div>
							<div style="color: darkgrey; height: 20px">Owned By: <a style="color: Purple; font-style: italic;" href="/User.aspx?ID=<?=$group->creator()->getUserId()?>"><?=$group->creator()->getUsername()?></a></div>
						</div>
