    ...
    <div class="Registration">
        ...
        <div id="ctl00_cphRoblox_upAccountRegistration">
            <div id="EnterUsername">
                <fieldset title="Choose a name for your Boomblox character">
                    <legend class="Legend">Choose a name for your Boomblox character</legend>
            ...
            <div id="EnterPassword">
                <fieldset title="Choose your Boomblox password">
                    <legend class="Legend">Choose your Boomblox password</legend>
                    <div class="Suggestion">
            ...
            <div id="EnterEmail">
                <fieldset title="Provide your parent's email address">		
                    <legend class="Legend">Provide your Boomblox key</legend>
                    <div class="Suggestion">
