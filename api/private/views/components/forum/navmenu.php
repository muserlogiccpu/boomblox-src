        ...
        <tbody>
            <tr>
                ...
                <td align="right" valign="middle">
                    ...
                    <a id="ctl00_cphRoblox_Navigationmenu1_ctl00_RegisterMenu" class="menuTextLink" href="/Forum/User/UserProfile.aspx?UserName=<?=$user->getUsername()?>">
                        <img src="/Forum/skins/default/images/icon_mini_register.gif" border="0">Profile &nbsp; </a>
                </td>
                <?php else: ?>
                <td align="right" valign="middle">
                    <a id="ctl00_cphRoblox_Navigationmenu1_ctl00_HomeMenu" class="menuTextLink" href="/Forum/Default.aspx">
